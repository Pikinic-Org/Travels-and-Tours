...
export const inputClass =
  "w-full rounded-lg border border-border-primary bg-surface-primary px-3 py-3 text-sm text-text-primary focus:border-green-700 focus:outline-none";
...
export const selectClass =
  "w-full rounded-lg border border-border-primary bg-surface-primary py-3 pl-3 pr-8 text-sm text-text-primary focus:border-green-700 focus:outline-none";
