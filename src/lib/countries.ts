// ISO 3166-1 alpha-2 country codes and names — used for the Nationality
// select on checkout. Static reference data (doesn't change), so no build
// step or API call needed, unlike the airport dataset.
